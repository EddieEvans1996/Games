...
class Evaluator():
    ...
    def material_eval(self, board):
        ...
        material_score = 900*(fen.count("K") - fen.count("k")) + 90*(fen.count("Q") - fen.count("q")) + 50*(fen.count("R") - fen.count("r")) + 30*(fen.count("N") + fen.count("B") - fen.count("b") - fen.count("n")) + 10*(fen.count("P") - fen.count("p"))
